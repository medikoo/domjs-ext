...
var d                 = require('d')
  ...
  , defineProperties = Object.defineProperties, ObservableMock
  , clear, toDOM, toDOMAttr, getValue, setValue, onNextTick;

ObservableMock = function (value) { this._value = value; };

defineProperties(ObservableMock.prototype, {
	value: d.gs(function () { return this._value; }),
	toDOM: d(function (document) {
		return normalize.call(document, this._value);
	}),
	toDOMAttr: d(function (element, name) {
		element.setAttribute(name, String(this._value));
		return this._value;
	})
});
...
module.exports = function (observable) {
	if (!isObservableValue(observable)) observable = new ObservableMock(observable);
