...
onNextTick = function () {
	...
	throw new TypeError("Unconsumed observable\n\n" +
		...
		"(eventually passthru via 'insert' function). Otherwise they won't be injected automatically " +
		"by the view engine (as it's the case with results of base domjs functions.\n\n" +
		"Value: " + String(this.value) + "\n" +
		"HTML: " + this.toDOM(document).innerHTML);
};
...
module.exports = function (observable) {
	...
	// Naturally we should use `nextTick`, still it appears as "too fast" for Firefox
